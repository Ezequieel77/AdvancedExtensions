...
| ```OUT_OF_COMBAT``` | Se ejecuta al salir de combate PvP. El tiempo necesario para abandonar el combate se define en `config.yml`. |
| ```ENTER_COMBAT``` | Se ejecuta al entrar en combate PvP (primer golpe realizado o recibido tras estar fuera de combate). |
